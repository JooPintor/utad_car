# Inicia o modulo 'realsense2_camera' com servidor de ROS no Raspberry PI 4
# Diferentes opções de arranque -> Apenas a linha com roslaunch que não começa por # é executada
