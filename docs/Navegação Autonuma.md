...
O estudo da navegação a este nivel centrou-se no [recurso a SLAM](./SLAM.md) e á [utilização da camara Intel Real Sense](./Utilização%20da%20camara%20Intel%20Real%20Sense.md), por terem sido os dispositivos disponibilizados pela Universidade para a realização dos estudos. 
