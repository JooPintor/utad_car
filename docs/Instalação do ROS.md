...
Um grande problema que o sistema Windows tem é que ele não possui nenhum program ou software que lhe permita buscar pacotes a partir a da net de uma forma direta como é possivel no cmd do Ubuntu.
